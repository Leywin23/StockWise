...
{
    /// <inheritdoc />
    public partial class CreatedAtCompany : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShoppingPriceAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ShoppingPriceCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
                    SellingPriceAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CompanyProductId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyProductName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    EAN = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    CompanyPriceAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CompanyPriceCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserNameWhoMadeOrder = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderTotalPriceAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OrderTotalPriceCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false)
                },
                constraints: table =>
                {
